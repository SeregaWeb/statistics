        ...
        clickInit.forEach((item) => {
            item.addEventListener('click', (e) => {
                ...
                if (contactNameInput && contactPhoneInput && contactPhoneExtInput && contactEmailInput) {
                    ...
                    // @ts-ignore
                    contactPhoneInput.value = `${jsonObj.direct_number}` ?? '';
                    // @ts-ignore
                    contactPhoneExtInput.value = `${jsonObj.direct_ext}` ?? '';
                    // @ts-ignore
                ...
                const templates = contacts
                    .map((contact) => {
                        ...
                        <input type="text" name="additional_contact_phone_ext[]" readonly value="${valueExt}" class="form-control js-additional-field-phone">
