		...
		<?php if ( ! $full_view_only ): ?>
            ...
            <div class="mb-2 col-12 col-md-6 col-xl-4">
                ...
                <input type="date" name="pick_up_date" class="form-control  js-shipper-date"
                       value="<?php echo $pick_up_date_formatted; ?>">
            </div>
            ...
            <div class="mb-2 col-12 col-md-6 col-xl-4">
                <div class="form-check form-switch">
                    <input class="form-check-input js-shipper-time-strict" name="pick_up_date_time_strict"
				...
				foreach ( $pick_up_location_isset as $val ):
                    ...
                    <div class="row js-current-shipper card-shipper">
                        <div class="d-none">
                            ...
                            <input type="hidden" class="js-current-shipper_short_address"
                    ...
                    <div class="row js-current-shipper card-shipper">
                        <div class="d-none">
                            ...
                            <input type="hidden" class="js-current-shipper_address" name="delivery_location_address[]"
                                   value="<?php echo $address ?>">
                            <input type="hidden" class="js-current-shipper_short_address"
                                   name="delivery_location_short_address[]"
                                   value="<?php echo $short_address ?>">
