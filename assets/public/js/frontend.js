...
function getLocationDataByZipCode(zipCode, apiKey) {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var endpoint, response, data, location, city, state, country;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          endpoint = "https://geocode.search.hereapi.com/v1/geocode?q=".concat(zipCode, "&in=countryCode%3AUSA%2CCAN%2CMEX&apiKey=").concat(apiKey);
          _context.prev = 1;
          _context.next = 4;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              _context2.prev = 12;
              _context2.next = 15;
              return getLocationDataByZipCode(value, key);
            case 15:
