...
<form class="ng-pristine ng-invalid ng-touched js-add-new-company">
    ...
    <div class="modal-body mb-5 row">
        <div class="form-group mt-3">
            ...
            <input id="input-name" type="text" required name="company_name" placeholder="Company Name"
                   class="form-control">
        </div>
        ...
        <div class="form-group mt-3">
            <div class="d-flex justify-content-between select-country">
                ...
                <div>
                    <input type="radio" checked name="country" value="USA" id="country-us"
        ...
        <div class="form-group mt-3 col-6">
            <label for="input-mcnumber" class="form-label">MC Number <span
                        class="required-star text-danger">*</span></label>
            <input id="input-mcnumber" required type="text" name="MotorCarrNo" placeholder="MC Number"
                   class="form-control">
        </div>
    ...
    <div class="modal-footer justify-content-start gap-2 mt-3">
        ...
        <button type="submit" class="btn btn-outline-primary">Submit <span class="spinner-border spinner-border-sm ms-2"
