    ...
    <div class="row">
        ...
        <div class="mb-3 col-12 col-xl-8 js-result-search-wrap">
            ...
            <div class="form-group position-relative js-container-search">
                <input id="input-name" type="text" required name="address"
                       placeholder=""
        ...
        <div class="mb-2 col-12 col-xl-4">
            ...
            <select name="stop_type"  class="form-control form-select js-shipper-stop-type" required>
        ...
        <div class="mb-2 col-12 col-xl-4">
            ...
            <input type="text" name="shipper_name" class="form-control  js-shipper-contact" required>
        </div>
        ...
        <div class="mb-2 col-12 col-md-6 col-xl-4">
            ...
            <input type="datetime-local" name="pick_up_date" class="form-control  js-shipper-date" required>
        </div>
        ...
        <div class="col-12 mt-3 mb-5 justify-content-start gap-2">
            <button class="btn btn-outline-primary js-add-point">Add point</button>
            <button class="btn btn-primary js-edit-point">End edit</button>
        </div>
        ...
        <div class="col-12 d-flex flex-column gap-2 js-table-shipper">
