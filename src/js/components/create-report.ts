...
export const pinnedMessageInit = (ajaxUrl) => {
    const pinnedMessage = document.querySelector('.js-pinned-message');
    pinnedMessage &&
        pinnedMessage.addEventListener('submit', (e) => {
            e.preventDefault();
            ...
            const btnSubmit = target.querySelector('button');
            btnSubmit && btnSubmit.setAttribute('disabled', 'true');
