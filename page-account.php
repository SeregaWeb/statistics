                    ...
                    <div class="col-12">
                        ...
                        <?php if ( $USER_OBJECT ) {
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="account-avatar" style="background-color: <?php echo $USER_OBJECT['color']; ?>">
                            ...
                            <div class="account-info">
		                        <?php if (is_array($USER_OBJECT['permission_project'])): ?>
                                    <div class="account-access">
                                        ...
                                        <h5>
                                            Access to projects
	                                        <?php if ($TMSUser->check_user_role_access(array('recruiter', 'billing', 'tracking'))) : ?>
                                        ...
                                        <div class="d-flex gap-1 mt-1">
                                            ...
                                            <li class="user-card">
                                                <div class="user-card__container">
                                                    <span class="user-card__circle" style="background-color: <?php echo $color; ?>">
                                                ...
                                                <a class="user-card__link link link-primary" href="<?php echo $account . '?user='. $user ?>">View profile</a>
                                            </li>
				                            <?php endforeach; ?>
                                            </ol>
                                        </div>
