    ...
    item.addEventListener('submit', function (event) {
      ...
      fetch(ajaxUrl, options).then(function (res) {
        ...
        if (requestStatus.success) {
          ...
          alert("Error adding company:".concat(requestStatus.data.message));
        }
    ...
    item.addEventListener('submit', function (event) {
      ...
      fetch(ajaxUrl, options).then(function (res) {
        ...
        if (requestStatus.success) {
          ...
          alert("Error adding report:".concat(requestStatus.data.message));
        }
      }).catch(function (error) {
        console.error('Request failed:', error);
      });
    ...
    item.addEventListener('submit', function (event) {
      ...
      fetch(ajaxUrl, options).then(function (res) {
        ...
        if (requestStatus.success) {
          ...
          alert("Error adding shipper:".concat(requestStatus.data.message));
        }
      }).catch(function (error) {
        console.error('Request failed:', error);
      });
