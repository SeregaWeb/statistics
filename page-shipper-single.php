                            ...
                            <form class="ng-pristine ng-invalid ng-touched js-update-shipper" style="max-width: 964px;">
                                ...
                                <div class="modal-body mb-3 row">
                                    <div class="form-group mt-3">
                                        ...
                                        <input id="input-name" type="text" required name="shipper_name"
                                               placeholder="Shipper Name"
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'shipper_name' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input id="input-address1" type="text" required name="Addr1"
                                               ...
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'address1' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input id="input-address2" type="text" name="Addr2" placeholder="Address 2"
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'address2' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input id="input-city" type="text" name="City" required placeholder="City"
                                               ...
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'city' ] ); ?>">
                                    </div>
                                        ...
                                        <select name="State" required class="form-control form-select js-state">
											...
											<?php if ( is_array( $load->select ) ): ?>
												<?php foreach ( $load->select as $key => $state ): ?>
                                                    <option value="<?php echo $key; ?>" <?php echo $shipper_fields[ 'state' ] === $key
														? 'selected' : ''; ?>>
														<?php echo htmlspecialchars( is_array( $state ) ? $state[ 0 ]
															: $state ); ?>
                                                    </option>
												<?php endforeach; ?>
											<?php endif; ?>
                                    ...
                                    <div class="form-group mt-3 col-6">
                                        ...
                                        <input id="input-firstname" type="text" name="FirstName"
                                               ...
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'contact_first_name' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3 col-6">
                                        ...
                                        <input id="input-lastname" type="text" name="LastName" placeholder="Last Name"
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'contact_last_name' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3 col-6">
                                        ...
                                        <input id="input-phone" type="text" name="Phone" placeholder="Phone"
                                               ...
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'phone_number' ] ); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-3 col-6">
                                        ...
                                        <input id="input-email" type="text" name="Email" placeholder="Email"
                                               class="form-control"
                                               value="<?php echo htmlspecialchars( $shipper_fields[ 'email' ] ); ?>">
                                    </div>
                                </div>
					...
					<?php if ( $remove_shipper ): ?>
                        <div class="col-12 d-flex justify-content-end">
                            <form class="js-delete-shipper text-end">
                                ...
                                <p class="text-small">the shipper will be permanently deleted, it will not be possible
                                    to return it</p>
                            </form>
                        </div>
					<?php endif; ?>
