<?php
/**
 * Template Name: Page add reports flt
 *
 * @package WP-rock
 * @since 4.4.0
 */
					...
					<?php if ( $access ): ?>
                        ...
                        <div class="col-12 js-update-status mt-3">
							...
							if ( 'Odysseia' === $reports->project && isset( $meta ) ) {
								...
								if ( $project === 'Odyssey' && $access_for_btn && isset( $status_publish ) && $status_publish === 'publish' && ! empty( $pick_up_location ) && ! empty( $delivery_location ) ) {
