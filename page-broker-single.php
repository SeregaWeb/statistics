                                ...
                                <div class="mt-3 mb-3" style="max-width: 944px;">
                                    ...
                                    <ul class="status-list">
										...
										if ( isset( $broker_meta[ 'factoring_broker' ] ) ) {
											...
											$status = isset( $loads->factoring_broker[ $broker_meta[ 'factoring_broker' ] ] )
												? $loads->factoring_broker[ $broker_meta[ 'factoring_broker' ] ] : '';
							...
							<?php if ( $add_broker ): ?>
                                <div class="tab-pane fade" id="pills-update" role="tabpanel"
									...
									function fill_field( $field_name, $data, $default = '' ) {
										return isset( $data[ $field_name ] ) ? esc_attr( $data[ $field_name ] )
											: $default;
									}
									...
									?>
                                    <form class="ng-pristine ng-invalid ng-touched js-update-company"
                                        ...
                                        <div class="modal-body mb-5 row">
													...
													<?php foreach ( $countries as $country ): ?>
                                                        <div>
                                                            <input type="radio" name="country"
																...
																<?php echo $broker_data[ 'country' ] === $country
																	? 'checked' : ''; ?>>
                                            ...
                                            <div class="form-group mt-3 col-6">
                                                ...
                                                <input id="input-address2" type="text" name="Addr2"
                                            ...
                                            <div class="form-group mt-3 col-6">
                                                ...
                                                <input id="input-dotnumber" type="text" name="DotNo"
                                            ...
                                            <div class="form-group mt-3 col-6">
                                                <label for="set_up_platform" class="form-label">Set up platform<span
                                                            class="required-star text-danger">*</span></label>
                                                <select name="set_up_platform" class="form-control form-select"
                                                        required>
                                            ...
                                            <div class="form-group mt-3 col-6">
                                                <label for="factoring_broker" class="form-label">Factoring
                                                    status</label>
                                            ...
                                            <div class="form-group mt-3 col-6">
                                                <label for="accounting-input-email" class="form-label">Accounting
                                                    Email</label>
