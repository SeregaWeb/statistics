...
require THEME_DIR . '/src/inc/core/class-tms-drivers-statistics.php';
...
require THEME_DIR . '/src/inc/core/class-tms-recruiter-transfer-manager.php';
require THEME_DIR . '/src/inc/admin/recruiter-transfer-status.php';
...
require THEME_DIR . '/src/inc/cron/recruiter-transfer-cron.php';
