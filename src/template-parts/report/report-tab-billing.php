...
<form class="js-uploads-billing d-grid">
    ...
    <div class="row">
        <div class="mb-2 col-12 col-md-6 col-xl-4">
            ...
            <select name="processing" class="form-control form-select js-show-hidden-values" required data-value="direct" data-selector=".js-select-type-direct">
        ...
        <div class="col-12 mb-2 js-select-type-direct <?php echo $hide_all_info; ?>">
            <div class="row">
                ...
                <div class="mb-2 col-12 col-md-6 col-xl-4">
                    ...
                    <select name="type_pay" class="form-control form-select js-show-hidden-values" data-required="true" data-value="quick-pay" data-selector=".js-select-quick-pay-percent">
                        <option value="delayed-advance" <?php echo $type_pay_method === 'delayed-advance' ? 'selected' : ''; ?>>Delayed advance</option>
                        <option value="quick-pay" <?php echo $type_pay_method === 'quick-pay' ? 'selected' : ''; ?>>Quick pay</option>
                    </select>
                </div>
                ...
                <div class="mb-2 col-12 col-md-6 col-xl-4 js-select-quick-pay-percent <?php echo $hide_dop_info; ?>">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">%</span>
                        <input type="number" value="<?php echo $percent_quick_pay; ?>" name="percent_quick_pay" class="form-control">
                    </div>
                </div>
            </div>
        </div>
...
<!--        </div>-->
        ...
        <div class="col-12 d-flex gap-2 mt-2 mb-4">
            <div class="form-check form-switch">
                <input class="form-check-input" <?php echo $rc_proof ? 'checked' : ''; ?> name="rc_proof" type="checkbox" id="rc_proof">
                <label class="form-check-label" for="rc_proof">Rate confirmation</label>
            </div>
            <div class="form-check form-switch">
                <input class="form-check-input" <?php echo $pod_proof ? 'checked' : ''; ?> name="pod_proof" type="checkbox" id="pod_proof">
                <label class="form-check-label" for="pod_proof">Proof of Delivery</label>
            </div>
            <div class="form-check form-switch">
                <input class="form-check-input" <?php echo $invoiced_proof ? 'checked' : ''; ?> name="invoiced_proof" type="checkbox" id="invoiced_proof">
