...
WHERE meta_pickup.meta_key = 'pick_up_location'
  AND meta_delivery.meta_key = 'delivery_location'";
	...
	public function get_locations_from_db_batch( $load_ids, $project = null, $is_flt = false ) {
		return parent::get_locations_from_db_batch( $load_ids, $project !== null ? $project : $this->project, true );
	}
	...
	public function add_pinned_message_flt() {
		...
		$result = $helper->add_pinned_message_for_reports( $this, $user_id, $post_id, $pinned_message, 'reports_flt' );
