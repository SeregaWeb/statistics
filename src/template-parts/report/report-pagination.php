...
echo paginate_links( array(
	'base'      =>  str_replace( 999999999, '%#%', esc_url(add_query_arg('paged', 999999999)) ), // База теперь просто '%#%'
	'format'    => '?paged=%#%', // Явно указываем формат '?paged='
	'total'     => $args['total_pages'], // Обязательно передаем общее количество страниц
